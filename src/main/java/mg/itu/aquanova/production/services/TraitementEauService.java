...
import mg.itu.aquanova.production.repositories.TraitementEauRepository;
...
public class TraitementEauService {
    ...
    public TraitementEauService(TraitementEauRepository repository) {
        this.repository = repository;
    }

    @Transactional
    public TraitementEau create(TraitementEau traitement) {
        // Validations strictes du cahier des charges
    ...
    @Transactional
    public TraitementEau update(Long id, TraitementEau details) {
        TraitementEau t = trouverParId(id);
        
        t.setBassin(details.getBassin());
        t.setTypeTraitementEau(details.getTypeTraitementEau());
        t.setDateTraitement(details.getDateTraitement());
        t.setDetail(details.getDetail());
        t.setObservation(details.getObservation());
    ...
    public List<TraitementEau> getByBassin(Long bassinId) {
        return repository.findByBassinIdOrderByDateTraitementDesc(bassinId);
    }
